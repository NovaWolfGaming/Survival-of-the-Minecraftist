...
public class BakedCrackledNetherwartItem extends SurvivalOfTheMinecraftistModElements.ModElement {
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			super(new Item.Properties().group(SOTMFoodsItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(6).saturation(0.75f).build()));
			setRegistryName("baked_crackled_netherwart");
		}
