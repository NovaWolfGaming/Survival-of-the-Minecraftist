...
public class PolishedColdBasaltBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:polished_cold_basalt")
	public static final Block block = null;
	public PolishedColdBasaltBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_cold_basalt");
		}
