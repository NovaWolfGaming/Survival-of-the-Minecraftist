...
import net.mcreator.survivaloftheminecraftist.procedures.NetherGeyserEntityWalksOnTheBlockProcedure;
...
public class BasaltGeyserBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.NETHERRACK).hardnessAndResistance(0.5f, 10f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("basalt_geyser");
		}
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			BlockState blockstate = world.getBlockState(pos);
			{
				...
				NetherGeyserEntityWalksOnTheBlockProcedure.executeProcedure($_dependencies);
			}
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("survival_of_the_minecraftist:basalt_geyser_match"),
			...
			event.getRegistry().register(feature.setRegistryName("basalt_geyser"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("survival_of_the_minecraftist:basalt_geyser"),
					configuredFeature);
		}
	}
	@SubscribeEvent
