...
public class PolishedShaleStairsBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:polished_shale_stairs")
	public static final Block block = null;
	public PolishedShaleStairsBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 504);
	}
