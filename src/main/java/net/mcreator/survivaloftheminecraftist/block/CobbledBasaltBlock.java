...
public class CobbledBasaltBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:cobbled_basalt")
	public static final Block block = null;
	public CobbledBasaltBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobbled_basalt");
		}
