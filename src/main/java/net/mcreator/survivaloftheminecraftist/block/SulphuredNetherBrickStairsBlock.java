...
public class SulphuredNetherBrickStairsBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:sulphured_nether_brick_stairs")
	public static final Block block = null;
	public SulphuredNetherBrickStairsBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 189);
	}
		...
		public CustomBlock() {
			super(() -> new Block(
					Block.Properties.create(Material.ROCK).sound(SoundType.NETHER_BRICK).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0))
							.getDefaultState(),
					Block.Properties.create(Material.ROCK).sound(SoundType.NETHER_BRICK).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0));
			setRegistryName("sulphured_nether_brick_stairs");
		}
