...
public class WarpedNetherrackBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("warped_netherrack");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("survival_of_the_minecraftist:warped_netherrack_match"),
			...
			event.getRegistry().register(feature.setRegistryName("warped_netherrack"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("survival_of_the_minecraftist:warped_netherrack"),
					configuredFeature);
		}
	}
	@SubscribeEvent
