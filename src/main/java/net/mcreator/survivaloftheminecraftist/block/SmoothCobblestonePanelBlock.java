...
public class SmoothCobblestonePanelBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:smooth_cobblestone_panel")
	public static final Block block = null;
	public SmoothCobblestonePanelBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 81);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("smooth_cobblestone_panel");
		}
