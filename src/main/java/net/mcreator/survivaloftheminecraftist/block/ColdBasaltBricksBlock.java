...
public class ColdBasaltBricksBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:cold_basalt_bricks")
	public static final Block block = null;
	public ColdBasaltBricksBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 196);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cold_basalt_bricks");
		}
