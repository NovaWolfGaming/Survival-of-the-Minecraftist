...
public class DarkNetherBrickSlabBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:dark_nether_brick_slab")
	public static final Block block = null;
	public DarkNetherBrickSlabBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 451);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_nether_brick_slab");
		}
