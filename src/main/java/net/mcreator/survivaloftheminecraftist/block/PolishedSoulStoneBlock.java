...
public class PolishedSoulStoneBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:polished_soul_stone")
	public static final Block block = null;
	public PolishedSoulStoneBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 260);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_soul_stone");
		}
