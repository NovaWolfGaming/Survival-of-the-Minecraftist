...
public class SoulQuartzStairsBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:soul_quartz_stairs")
	public static final Block block = null;
	public SoulQuartzStairsBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 302);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("soul_quartz_stairs");
		}
