...
public class PolishedHotBasaltBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:polished_hot_basalt")
	public static final Block block = null;
	public PolishedHotBasaltBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 59);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_hot_basalt");
		}
