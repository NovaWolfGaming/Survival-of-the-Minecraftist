...
public class PolishedBasaltBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:polished_basalt")
	public static final Block block = null;
	public PolishedBasaltBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 164);
	}
