...
public class LimestoneBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:limestone")
	public static final Block block = null;
	public LimestoneBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 51);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("survival_of_the_minecraftist:limestone_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("survival_of_the_minecraftist:limestone"),
					configuredFeature);
		}
	}
	@SubscribeEvent
