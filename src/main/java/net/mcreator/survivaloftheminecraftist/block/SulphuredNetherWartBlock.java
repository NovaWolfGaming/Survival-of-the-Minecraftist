...
import net.mcreator.survivaloftheminecraftist.item.SulphuredNetherWartItemItem;
...
public class SulphuredNetherWartBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("sulphured_nether_wart"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("survival_of_the_minecraftist:sulphured_nether_wart"),
					configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SPEED, 5, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.NETHER_WART)
					.hardnessAndResistance(0f, 0f).setLightLevel(s -> 0));
			setRegistryName("sulphured_nether_wart");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SulphuredNetherWartItemItem.block));
		}
