...
public class BloodBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:blood")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("survival_of_the_minecraftist:blood_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public BloodBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 1);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing, FluidAttributes
				.builder(new ResourceLocation("survival_of_the_minecraftist:blocks/blood_still"),
						new ResourceLocation("survival_of_the_minecraftist:blocks/blood_flow_2"))
				.luminosity(0).density(1000).viscosity(1000).temperature(300).rarity(Rarity.COMMON)
				.sound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("item.bucket.empty")))).explosionResistance(100f).tickRate(5)
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("survival_of_the_minecraftist:blood_lakes"),
					configuredFeature);
		}
	}
	@SubscribeEvent
