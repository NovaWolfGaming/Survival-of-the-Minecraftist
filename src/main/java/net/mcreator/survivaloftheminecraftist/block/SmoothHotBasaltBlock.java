...
public class SmoothHotBasaltBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:smooth_hot_basalt")
	public static final Block block = null;
	public SmoothHotBasaltBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_hot_basalt");
		}
