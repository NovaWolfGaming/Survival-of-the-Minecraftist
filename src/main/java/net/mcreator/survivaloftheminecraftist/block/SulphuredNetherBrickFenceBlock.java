...
public class SulphuredNetherBrickFenceBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:sulphured_nether_brick_fence")
	public static final Block block = null;
	public SulphuredNetherBrickFenceBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 227);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("sulphured_nether_brick_fence");
		}
