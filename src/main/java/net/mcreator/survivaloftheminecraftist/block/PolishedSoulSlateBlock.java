...
public class PolishedSoulSlateBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:polished_soul_slate")
	public static final Block block = null;
	public PolishedSoulSlateBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 70);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_soul_slate");
		}
