...
public class FlameNetherBrickWallBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:flame_nether_brick_wall")
	public static final Block block = null;
	public FlameNetherBrickWallBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 437);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("flame_nether_brick_wall");
		}
