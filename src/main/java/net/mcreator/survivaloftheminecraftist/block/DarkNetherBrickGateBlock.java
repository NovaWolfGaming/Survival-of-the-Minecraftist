...
public class DarkNetherBrickGateBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:dark_nether_brick_gate")
	public static final Block block = null;
	public DarkNetherBrickGateBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 427);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_nether_brick_gate");
		}
