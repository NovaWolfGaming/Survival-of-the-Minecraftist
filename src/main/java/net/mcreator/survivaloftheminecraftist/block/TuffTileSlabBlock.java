...
public class TuffTileSlabBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:tuff_tile_slab")
	public static final Block block = null;
	public TuffTileSlabBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 543);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("tuff_tile_slab");
		}
