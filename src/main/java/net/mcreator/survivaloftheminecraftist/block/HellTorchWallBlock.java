...
import net.mcreator.survivaloftheminecraftist.procedures.HellTorchWallNeighbourBlockChangesProcedure;
...
public class HellTorchWallBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:hell_torch_wall")
	public static final Block block = null;
	public HellTorchWallBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 228);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hell_torch_wall");
		}
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			}
			{
				...
				HellTorchWallNeighbourBlockChangesProcedure.executeProcedure($_dependencies);
			}
		}
