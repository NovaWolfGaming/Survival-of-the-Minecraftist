...
public class PolishedTuffBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:polished_tuff")
	public static final Block block = null;
	public PolishedTuffBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 523);
	}
