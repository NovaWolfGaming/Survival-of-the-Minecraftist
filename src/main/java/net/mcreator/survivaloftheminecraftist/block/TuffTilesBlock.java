...
public class TuffTilesBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:tuff_tiles")
	public static final Block block = null;
	public TuffTilesBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 524);
	}
