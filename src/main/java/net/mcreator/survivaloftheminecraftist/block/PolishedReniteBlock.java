...
public class PolishedReniteBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:polished_renite")
	public static final Block block = null;
	public PolishedReniteBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_renite");
		}
