...
public class SmoothDarkQuartzStairsBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:smooth_dark_quartz_stairs")
	public static final Block block = null;
	public SmoothDarkQuartzStairsBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 101);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_dark_quartz_stairs");
		}
