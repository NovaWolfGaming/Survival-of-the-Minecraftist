...
public class SmoothSoulQuartzSlabBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:smooth_soul_quartz_slab")
	public static final Block block = null;
	public SmoothSoulQuartzSlabBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 316);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_soul_quartz_slab");
		}
