...
public class GilnorBlockBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:gilnor_block")
	public static final Block block = null;
	public GilnorBlockBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 192);
	}
