...
public class SoulSlateBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:soul_slate")
	public static final Block block = null;
	public SoulSlateBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 324);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("survival_of_the_minecraftist:soul_slate_match"),
			...
			event.getRegistry().register(feature.setRegistryName("soul_slate"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("survival_of_the_minecraftist:soul_slate"),
					configuredFeature);
		}
	}
	@SubscribeEvent
