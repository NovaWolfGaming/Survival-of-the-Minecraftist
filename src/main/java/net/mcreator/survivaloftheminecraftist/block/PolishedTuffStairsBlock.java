...
public class PolishedTuffStairsBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:polished_tuff_stairs")
	public static final Block block = null;
	public PolishedTuffStairsBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 530);
	}
