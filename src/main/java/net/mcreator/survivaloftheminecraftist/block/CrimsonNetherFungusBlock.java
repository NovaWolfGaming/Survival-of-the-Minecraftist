...
public class CrimsonNetherFungusBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.SOUL_SOIL).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0));
			setRegistryName("crimson_nether_fungus");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("survival_of_the_minecraftist:crimson_nether_fungus_match"),
			...
			event.getRegistry().register(feature.setRegistryName("crimson_nether_fungus"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("survival_of_the_minecraftist:crimson_nether_fungus"),
					configuredFeature);
		}
	}
	@SubscribeEvent
