...
public class FlameNetherBrickSlabBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:flame_nether_brick_slab")
	public static final Block block = null;
	public FlameNetherBrickSlabBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 447);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("flame_nether_brick_slab");
		}
