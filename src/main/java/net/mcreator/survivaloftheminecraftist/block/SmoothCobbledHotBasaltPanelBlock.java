...
public class SmoothCobbledHotBasaltPanelBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:smooth_cobbled_hot_basalt_panel")
	public static final Block block = null;
	public SmoothCobbledHotBasaltPanelBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_cobbled_hot_basalt_panel");
		}
