...
public class DarkNetherBricksFenceBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:dark_nether_bricks_fence")
	public static final Block block = null;
	public DarkNetherBricksFenceBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 419);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_nether_bricks_fence");
		}
