...
public class SulphuredNetherBricksBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:sulphured_nether_bricks")
	public static final Block block = null;
	public SulphuredNetherBricksBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 461);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sulphured_nether_bricks");
		}
