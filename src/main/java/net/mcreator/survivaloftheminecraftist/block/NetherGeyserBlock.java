...
public class NetherGeyserBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("survival_of_the_minecraftist:nether_geyser_match"),
			...
			event.getRegistry().register(feature.setRegistryName("nether_geyser"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("survival_of_the_minecraftist:nether_geyser"),
					configuredFeature);
		}
	}
	@SubscribeEvent
