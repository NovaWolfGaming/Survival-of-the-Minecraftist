...
public class PolishedCobbledBasaltBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:polished_cobbled_basalt")
	public static final Block block = null;
	public PolishedCobbledBasaltBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 128);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_cobbled_basalt");
		}
