...
public class SmoothBasaltBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:smooth_basalt")
	public static final Block block = null;
	public SmoothBasaltBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 191);
	}
