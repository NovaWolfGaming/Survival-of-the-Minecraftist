...
public class SoulSlateBrickSlabBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:soul_slate_brick_slab")
	public static final Block block = null;
	public SoulSlateBrickSlabBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 74);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("soul_slate_brick_slab");
		}
