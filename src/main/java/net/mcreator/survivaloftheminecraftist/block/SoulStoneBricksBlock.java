...
public class SoulStoneBricksBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:soul_stone_bricks")
	public static final Block block = null;
	public SoulStoneBricksBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 262);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("soul_stone_bricks");
		}
