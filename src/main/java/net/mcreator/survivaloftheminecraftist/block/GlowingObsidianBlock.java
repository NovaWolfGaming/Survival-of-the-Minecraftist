...
public class GlowingObsidianBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("survival_of_the_minecraftist:glowing_obsidian_match"),
			...
			event.getRegistry().register(feature.setRegistryName("glowing_obsidian"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("survival_of_the_minecraftist:glowing_obsidian"),
					configuredFeature);
		}
	}
	@SubscribeEvent
