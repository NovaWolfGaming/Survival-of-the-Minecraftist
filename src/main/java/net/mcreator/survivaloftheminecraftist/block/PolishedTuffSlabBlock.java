...
public class PolishedTuffSlabBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:polished_tuff_slab")
	public static final Block block = null;
	public PolishedTuffSlabBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 534);
	}
