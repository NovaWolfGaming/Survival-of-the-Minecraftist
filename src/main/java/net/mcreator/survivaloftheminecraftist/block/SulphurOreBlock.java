...
public class SulphurOreBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:sulphur_ore")
	public static final Block block = null;
	public SulphurOreBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 34);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("survival_of_the_minecraftist:sulphur_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("survival_of_the_minecraftist:sulphur_ore"),
					configuredFeature);
		}
	}
	@SubscribeEvent
