...
public class ChiseledSoulSlateBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:chiseled_soul_slate")
	public static final Block block = null;
	public ChiseledSoulSlateBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 331);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_soul_slate");
		}
