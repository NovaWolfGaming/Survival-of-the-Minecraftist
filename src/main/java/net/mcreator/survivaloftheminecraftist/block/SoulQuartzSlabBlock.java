...
public class SoulQuartzSlabBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:soul_quartz_slab")
	public static final Block block = null;
	public SoulQuartzSlabBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 304);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("soul_quartz_slab");
		}
