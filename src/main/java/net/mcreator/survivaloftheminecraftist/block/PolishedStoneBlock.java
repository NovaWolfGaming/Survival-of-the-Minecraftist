...
public class PolishedStoneBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:polished_stone")
	public static final Block block = null;
	public PolishedStoneBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 230);
	}
