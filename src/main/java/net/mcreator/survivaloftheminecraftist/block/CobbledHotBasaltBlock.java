...
public class CobbledHotBasaltBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:cobbled_hot_basalt")
	public static final Block block = null;
	public CobbledHotBasaltBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 212);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobbled_hot_basalt");
		}
