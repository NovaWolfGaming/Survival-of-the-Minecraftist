...
public class SmoothDarkQuartzSlabBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:smooth_dark_quartz_slab")
	public static final Block block = null;
	public SmoothDarkQuartzSlabBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 103);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_dark_quartz_slab");
		}
