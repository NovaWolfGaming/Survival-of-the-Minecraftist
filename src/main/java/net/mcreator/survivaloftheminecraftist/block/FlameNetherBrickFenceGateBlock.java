...
public class FlameNetherBrickFenceGateBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:flame_nether_brick_fence_gate")
	public static final Block block = null;
	public FlameNetherBrickFenceGateBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 429);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("flame_nether_brick_fence_gate");
		}
