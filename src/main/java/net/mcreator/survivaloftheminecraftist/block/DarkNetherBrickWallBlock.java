...
public class DarkNetherBrickWallBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:dark_nether_brick_wall")
	public static final Block block = null;
	public DarkNetherBrickWallBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 224);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_nether_brick_wall");
		}
