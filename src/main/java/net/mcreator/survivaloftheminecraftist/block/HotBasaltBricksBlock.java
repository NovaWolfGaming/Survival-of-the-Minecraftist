...
public class HotBasaltBricksBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:hot_basalt_bricks")
	public static final Block block = null;
	public HotBasaltBricksBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 62);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hot_basalt_bricks");
		}
