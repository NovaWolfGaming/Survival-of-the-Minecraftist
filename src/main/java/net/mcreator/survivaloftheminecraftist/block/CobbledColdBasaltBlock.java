...
public class CobbledColdBasaltBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:cobbled_cold_basalt")
	public static final Block block = null;
	public CobbledColdBasaltBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobbled_cold_basalt");
		}
