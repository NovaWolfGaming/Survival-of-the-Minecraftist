...
public class SmoothSulphurQuartzStairsBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:smooth_sulphur_quartz_stairs")
	public static final Block block = null;
	public SmoothSulphurQuartzStairsBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 249);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_sulphur_quartz_stairs");
		}
