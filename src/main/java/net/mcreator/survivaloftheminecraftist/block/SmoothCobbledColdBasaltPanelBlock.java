...
public class SmoothCobbledColdBasaltPanelBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:smooth_cobbled_cold_basalt_panel")
	public static final Block block = null;
	public SmoothCobbledColdBasaltPanelBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 57);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_cobbled_cold_basalt_panel");
		}
