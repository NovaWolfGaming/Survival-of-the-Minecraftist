...
public class BloodQuartzStairsBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:blood_quartz_stairs")
	public static final Block block = null;
	public BloodQuartzStairsBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 141);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blood_quartz_stairs");
		}
