...
public class SoulSlateBrickBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:soul_slate_brick")
	public static final Block block = null;
	public SoulSlateBrickBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 328);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("soul_slate_brick");
		}
