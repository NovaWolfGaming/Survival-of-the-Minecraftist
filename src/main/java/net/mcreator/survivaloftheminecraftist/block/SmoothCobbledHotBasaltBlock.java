...
public class SmoothCobbledHotBasaltBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:smooth_cobbled_hot_basalt")
	public static final Block block = null;
	public SmoothCobbledHotBasaltBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 213);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_cobbled_hot_basalt");
		}
