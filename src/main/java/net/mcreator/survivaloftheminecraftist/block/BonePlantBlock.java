...
public class BonePlantBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SPEED, 5, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.BONE)
					.hardnessAndResistance(0f, 0f).setLightLevel(s -> 0));
			setRegistryName("bone_plant");
		}
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == Blocks.SOUL_SOIL);
		}
