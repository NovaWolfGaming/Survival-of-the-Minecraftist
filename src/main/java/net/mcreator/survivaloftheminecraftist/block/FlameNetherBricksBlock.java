...
public class FlameNetherBricksBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:flame_nether_bricks")
	public static final Block block = null;
	public FlameNetherBricksBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 178);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("flame_nether_bricks");
		}
