...
public class GilnorPillarBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:gilnor_pillar")
	public static final Block block = null;
	public GilnorPillarBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 193);
	}
