...
public class CalciteBricksBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:calcite_bricks")
	public static final Block block = null;
	public CalciteBricksBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 550);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("calcite_bricks");
		}
