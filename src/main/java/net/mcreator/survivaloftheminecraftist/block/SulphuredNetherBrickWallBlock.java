...
public class SulphuredNetherBrickWallBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:sulphured_nether_brick_wall")
	public static final Block block = null;
	public SulphuredNetherBrickWallBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 467);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("sulphured_nether_brick_wall");
		}
