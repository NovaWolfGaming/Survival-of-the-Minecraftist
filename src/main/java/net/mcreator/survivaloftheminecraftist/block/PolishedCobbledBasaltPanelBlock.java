...
public class PolishedCobbledBasaltPanelBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:polished_cobbled_basalt_panel")
	public static final Block block = null;
	public PolishedCobbledBasaltPanelBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_cobbled_basalt_panel");
		}
