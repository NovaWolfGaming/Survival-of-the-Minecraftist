...
public class SmoothSoulQuartzStairsBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:smooth_soul_quartz_stairs")
	public static final Block block = null;
	public SmoothSoulQuartzStairsBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 314);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_soul_quartz_stairs");
		}
