...
public class SmoothSulphurQuartzSlabBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:smooth_sulphur_quartz_slab")
	public static final Block block = null;
	public SmoothSulphurQuartzSlabBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 159);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_sulphur_quartz_slab");
		}
