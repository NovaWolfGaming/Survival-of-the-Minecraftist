...
public class SmoothCobbledColdBasaltBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:smooth_cobbled_cold_basalt")
	public static final Block block = null;
	public SmoothCobbledColdBasaltBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 56);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_cobbled_cold_basalt");
		}
