...
import net.mcreator.survivaloftheminecraftist.item.SulphurQuartzItem;
...
public class SulphurQuartzOreBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("survival_of_the_minecraftist:sulphur_quartz_ore_match"),
