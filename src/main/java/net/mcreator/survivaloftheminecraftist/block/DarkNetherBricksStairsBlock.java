...
public class DarkNetherBricksStairsBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:dark_nether_bricks_stairs")
	public static final Block block = null;
	public DarkNetherBricksStairsBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 449);
	}
		...
		public CustomBlock() {
			super(() -> new Block(
					Block.Properties.create(Material.ROCK).sound(SoundType.NETHER_BRICK).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0))
							.getDefaultState(),
					Block.Properties.create(Material.ROCK).sound(SoundType.NETHER_BRICK).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0));
			setRegistryName("dark_nether_bricks_stairs");
		}
