...
public class ColdBasaltPanelBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:cold_basalt_panel")
	public static final Block block = null;
	public ColdBasaltPanelBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 194);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cold_basalt_panel");
		}
