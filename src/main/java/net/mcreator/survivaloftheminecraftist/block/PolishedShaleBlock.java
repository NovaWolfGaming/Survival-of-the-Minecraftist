...
public class PolishedShaleBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:polished_shale")
	public static final Block block = null;
	public PolishedShaleBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 78);
	}
