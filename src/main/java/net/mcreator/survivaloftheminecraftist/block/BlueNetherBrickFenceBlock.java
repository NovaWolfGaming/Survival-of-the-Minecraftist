...
public class BlueNetherBrickFenceBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:blue_nether_brick_fence")
	public static final Block block = null;
	public BlueNetherBrickFenceBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 426);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_nether_brick_fence");
		}
