...
public class YellownetherBushBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("yellownether_bush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("survival_of_the_minecraftist:yellownether_bush"),
					configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.GLOWING, 5, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.NETHER_VINE_LOWER_PITCH)
					.hardnessAndResistance(0f, 0f).setLightLevel(s -> 0));
			setRegistryName("yellownether_bush");
		}
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == Blocks.SOUL_SAND || ground == Blocks.SOUL_SOIL || ground == Blocks.NETHERRACK);
		}
