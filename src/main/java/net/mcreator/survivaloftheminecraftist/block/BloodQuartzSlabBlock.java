...
public class BloodQuartzSlabBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:blood_quartz_slab")
	public static final Block block = null;
	public BloodQuartzSlabBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 143);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blood_quartz_slab");
		}
