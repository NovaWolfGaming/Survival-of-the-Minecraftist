...
public class HotBasaltPanelBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	@ObjectHolder("survival_of_the_minecraftist:hot_basalt_panel")
	public static final Block block = null;
	public HotBasaltPanelBlock(SurvivalOfTheMinecraftistModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hot_basalt_panel");
		}
