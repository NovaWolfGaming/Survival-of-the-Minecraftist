...
public class SulphuredBasaltBlock extends SurvivalOfTheMinecraftistModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sulphured_basalt");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("survival_of_the_minecraftist:sulphured_basalt_match"),
			...
			event.getRegistry().register(feature.setRegistryName("sulphured_basalt"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("survival_of_the_minecraftist:sulphured_basalt"),
					configuredFeature);
		}
	}
	@SubscribeEvent
