...
import net.mcreator.survivaloftheminecraftist.procedures.FireStarterEffectStartedappliedProcedure;

import java.util.Map;
import java.util.HashMap;

@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
public class FireStarterPotionEffect {
	@ObjectHolder("survival_of_the_minecraftist:fire_starter")
	...
	public static class EffectCustom extends Effect {
		...
		public void affectEntity(Entity source, Entity indirectSource, LivingEntity entity, int amplifier, double health) {
			...
			double z = entity.getPosZ();
			{
				...
				FireStarterEffectStartedappliedProcedure.executeProcedure($_dependencies);
			}
		}
