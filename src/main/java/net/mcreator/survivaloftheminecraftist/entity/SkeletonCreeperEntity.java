...
import net.mcreator.survivaloftheminecraftist.entity.renderer.SkeletonCreeperRenderer;
import net.mcreator.survivaloftheminecraftist.SurvivalOfTheMinecraftistModElements;

@SurvivalOfTheMinecraftistModElements.ModElement.Tag
public class SkeletonCreeperEntity extends SurvivalOfTheMinecraftistModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -13421773, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("skeleton_creeper_spawn_egg"));
	}
