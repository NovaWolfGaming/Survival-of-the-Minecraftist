...
import net.mcreator.survivaloftheminecraftist.entity.renderer.FlyingWitherSkullRenderer;
import net.mcreator.survivaloftheminecraftist.SurvivalOfTheMinecraftistModElements;

import java.util.Random;

@SurvivalOfTheMinecraftistModElements.ModElement.Tag
public class FlyingWitherSkullEntity extends SurvivalOfTheMinecraftistModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -10027009, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("flying_wither_skull_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 13, 1, 2));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, SoulBeastEntity.CustomEntity.class, true, false));
		}
